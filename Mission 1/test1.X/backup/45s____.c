...
int left_down(void){
    ...
    wait00(12); /* 0.18msec wait */
    PORTC=0x00; /* both motor off */
    wait00(12); /* 0.79msec wait */
    return 1;
}
...
int left_down_sharp(void){
    ...
    //wait00(0.05); /* 0.03msec wait */
    PORTC=0x02; /* right motor on */
    wait00(6); /* 0.18msec wait */
    PORTC=0x00; /* both motor off */
    wait00(2); /* 0.79msec wait */
    return 3;
}
...
int straight(void){
    PORTC=0x03; /* both motor on */
    wait00(7); /* 0.20msec wait */
    PORTC=0x00; /* both motor off */
    wait00(6); /* 0.80msec wait */
    return 0;
}

int accelerate(void){
    PORTC=0x03; /* both motor on */
    wait00(16); /* 0.20msec wait */
    PORTC=0x00; /* both motor off */
    wait00(1); /* 0.80msec wait */
    return 0;
}
